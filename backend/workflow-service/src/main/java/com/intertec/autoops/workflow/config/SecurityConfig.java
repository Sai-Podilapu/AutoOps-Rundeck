...
import com.intertec.autoops.workflow.security.InternalTokenFilter;
import com.intertec.autoops.workflow.security.RestAuthEntryPoint;
...
public class SecurityConfig {
    ...
    @Bean
    public JwtDecoder jwtDecoder(WorkflowProperties properties) {
