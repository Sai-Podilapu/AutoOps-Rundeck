 ...
 * {@code X-Internal-Token}. This service is deliberately NOT behind the API
 * gateway and publishes no host port — the token is defence-in-depth for
...
public class InternalTokenFilter extends OncePerRequestFilter {
    ...
    public InternalTokenFilter(JobProperties properties) {
